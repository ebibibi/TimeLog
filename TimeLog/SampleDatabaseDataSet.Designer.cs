...
namespace TimeLog {
    ...
    public partial class SampleDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class JobsDataTable : global::System.Data.TypedTableBase<JobsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public JobsRow AddJobsRow(string jobID, string name, System.DateTime startTime, System.DateTime endTime, bool isRunning, string totalWorkingTime) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public JobsRow FindByjobID(string jobID) {
            ...
            private void InitClass() {
                ...
                this.columnjobID.MaxLength = 4000;
...
namespace TimeLog.SampleDatabaseDataSetTableAdapters {
    ...
    public partial class @__MigrationHistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        public virtual int Fill(SampleDatabaseDataSet.@__MigrationHistoryDataTable dataTable) {
        ...
        public virtual SampleDatabaseDataSet.@__MigrationHistoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SampleDatabaseDataSet.@__MigrationHistoryDataTable dataTable = new SampleDatabaseDataSet.@__MigrationHistoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SampleDatabaseDataSet.@__MigrationHistoryDataTable dataTable) {
    ...
    public partial class JobsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@Original_jobID", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, true, 0, 0, "jobID", global::System.Data.DataRowVersion.Original, null));
            this._adapter.InsertCommand = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Jobs] ([jobID], [name], [startTime], [endTime], [isRunning], [totalW" +
                "orkingTime]) VALUES (@jobID, @name, @startTime, @endTime, @isRunning, @totalWork" +
                "ingTime)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@jobID", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, true, 0, 0, "jobID", global::System.Data.DataRowVersion.Current, null));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [Jobs] SET [jobID] = @jobID, [name] = @name, [startTime] = @startTime, [en" +
                "dTime] = @endTime, [isRunning] = @isRunning, [totalWorkingTime] = @totalWorkingT" +
                "ime WHERE (([jobID] = @Original_jobID))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@jobID", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, true, 0, 0, "jobID", global::System.Data.DataRowVersion.Current, null));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@Original_jobID", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, true, 0, 0, "jobID", global::System.Data.DataRowVersion.Original, null));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(SampleDatabaseDataSet.JobsDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual SampleDatabaseDataSet.JobsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SampleDatabaseDataSet.JobsDataTable dataTable = new SampleDatabaseDataSet.JobsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SampleDatabaseDataSet.JobsDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(string Original_jobID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string jobID, string name, System.DateTime startTime, System.DateTime endTime, bool isRunning, string totalWorkingTime) {
            if ((jobID == null)) {
            ...
            if ((totalWorkingTime == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(totalWorkingTime));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.InsertCommand.Connection.State;
            if (((this.Adapter.InsertCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string jobID, string name, System.DateTime startTime, System.DateTime endTime, bool isRunning, string totalWorkingTime, string Original_jobID) {
            if ((jobID == null)) {
                throw new global::System.ArgumentNullException("jobID");
            }
            else {
            ...
            if ((totalWorkingTime == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(totalWorkingTime));
            }
            if ((Original_jobID == null)) {
                throw new global::System.ArgumentNullException("Original_jobID");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, System.DateTime startTime, System.DateTime endTime, bool isRunning, string totalWorkingTime, string Original_jobID) {
            return this.Update(Original_jobID, name, startTime, endTime, isRunning, totalWorkingTime, Original_jobID);
        }
    }
