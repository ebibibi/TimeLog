...
namespace TimeLogTest {
    ...
    public partial class SampleDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class JobsDataTable : global::System.Data.TypedTableBase<JobsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public JobsRow AddJobsRow(string name, System.DateTime startTime, System.DateTime endTime, bool isRunning) {
...
namespace TimeLogTest.SampleDatabaseDataSetTableAdapters {
    ...
    public partial class @__MigrationHistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TimeLogTest.Properties.Settings.Default.forTest;
        }
    ...
    public partial class JobsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Jobs] ([name], [startTime], [endTime], [isRunning]) VALUES (@name, @" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Jobs] SET [name] = @name, [startTime] = @startTime, [endTime] = @endTime," +
                " [isRunning] = @isRunning WHERE (([jobID] = @Original_jobID))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT [jobID], [name], [startTime], [endTime], [isRunning] FROM [Jobs]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string name, System.DateTime startTime, System.DateTime endTime, bool isRunning) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, System.DateTime startTime, System.DateTime endTime, bool isRunning, int Original_jobID) {
            if ((name == null)) {
